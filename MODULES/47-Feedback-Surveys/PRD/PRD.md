# PRD — Feedback Surveys

**Purpose.** Structured feedback loops inside the school.

**Primary roles.** admin, principal; student respond

**Core workflow.** Admin opens survey → students respond → aggregate view.

## Scope (current edition)
- Student→teacher feedback surveys
- Aggregated results
