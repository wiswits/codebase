...
**Purpose.** School photo memory lane, powering event albums too.

**Primary roles.** admin/teacher manage; all view

**Core workflow.** Create album → upload → viewers browse by role.

## Scope (current edition)
- Albums (event-linked + standalone)
- Role-aware viewer for students/parents
