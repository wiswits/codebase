...
**Purpose.** Curated learning content delivered white-label — no third-party branding ever visible.

**Primary roles.** admin, teacher, student

**Core workflow.** WisWits content factory publishes → school library → student Study Zone.

## Scope (current edition)
- Study Zone for students
- White-label media viewer (SecureFileFrame, WisWitsVideo)
- Backed by CMS store
