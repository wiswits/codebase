...
- **Own code (frozen prod snapshot):** `code/apps/…` — analytics.module.js analytics.routes.js 
- **Own/feature tables:** `client_attendance_records`, `client_attendance_sessions`, `client_fee_assignments`, `client_fee_payments`, `client_quiz_attempts`, `client_quizzes`
