...
## Backend
- `apps/backend/src/modules/gallery/`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — gallery.module.js gallery.routes.js 
- **Own/feature tables:** `client_em_events`, `client_events`, `client_gallery_albums`, `client_gallery_photos`, `client_timetable_slots`
