...
## Backend
- `apps/backend/src/modules/hrms/`

## Frontend
- `apps/web/src/app/(dashboard)/hr/ (?tab=leaves)`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — hrms.module.js 
- **Own/feature tables:** `client_leave_requests`, `client_leave_types`, `client_notifications`
