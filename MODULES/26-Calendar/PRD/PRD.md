...
**Purpose.** One calendar aggregating events, exams, and holidays; subscribable from phones.

**Primary roles.** all roles

**Core workflow.** Sources feed in → per-role calendar renders → optional ICS subscribe.
