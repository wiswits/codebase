...
## Backend
- `apps/backend/src/modules/custom-fields/ (customFields.service.js)`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — customFields.module.js customFields.routes.js 
- **Own/feature tables:** —
- **Spine tables read (Core — cannot be cut):** none
- **Cross-module code imports:** ../features/governance 
