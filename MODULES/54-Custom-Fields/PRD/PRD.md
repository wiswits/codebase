...
**Purpose.** Schools extend records without code — configuration over customization (§3).

**Primary roles.** admin

**Core workflow.** Define field → appears on forms → stored + searchable.

## Scope (current edition)
- No-code field engine on students/staff
