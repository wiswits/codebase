...
**Purpose.** Leave management for all staff.

**Primary roles.** staff self; hr_manager/principal approve

**Core workflow.** Staff applies → approver decides → balances update.
