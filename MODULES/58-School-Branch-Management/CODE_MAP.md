# Code Map — School Branch Management
...
## Backend
- `apps/backend/src/modules/schools/`
- `apps/backend/src/modules/blueprints/ (institution)`

## Frontend
- `apps/web/src/app/(dashboard)/admin/institutes/ (no nav entry — Day-1 wiring)`
