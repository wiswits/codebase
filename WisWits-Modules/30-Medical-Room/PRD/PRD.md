...
**Purpose.** Campus healthcare records. Explicitly gated until Phase 1 is stable AND AK green-lights.
...
## Status vs spec
Current status: **HOLD — §16-gated non-goal, AK's explicit call required** — see `../STATUS.md`. Gaps between this PRD and the live
