...
## Backend
- `apps/backend/src/modules/groups/`

## Frontend
- `apps/web/src/app/(dashboard)/people/groups/`
- `navConfig: People > Groups (soon:true)`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — groups.module.js groups.routes.js 
- **Own/feature tables:** `client_student_group_members`, `client_student_groups`
