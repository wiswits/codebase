...
**Purpose.** Workforce utilization analytics. Waits for upstream assembly AND a value case.
...
## Status vs spec
Current status: **HOLD — blocked upstream + low priority** — see `../STATUS.md`. Gaps between this PRD and the live
