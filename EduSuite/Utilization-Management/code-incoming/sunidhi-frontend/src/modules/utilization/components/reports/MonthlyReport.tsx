// src/modules/utilization/components/reports/MonthlyReport.tsx
//
// Preset report view: monthly utilization, grouped by employee by
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">Utilization for the current month.</p>
        </div>
        <div className="flex items-center gap-3">
          ...
          <ReportExport items={items} fileName="monthly-utilization-report" />
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        {loading && <LoadingState label="Loading monthly report" />}
        {!loading && error && (
