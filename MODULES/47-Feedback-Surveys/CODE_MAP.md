...
## Frontend
- `apps/web/src/app/(dashboard)/feedback/`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — feedback.module.js feedback.routes.js 
- **Own/feature tables:** `client_subjects`, `client_teacher_feedback`, `client_timetable_slots`
- **Spine tables read (Core — cannot be cut):** `client_enrollments`, `client_roles`, `client_students`, `client_user_roles`, `client_users`
