...
## Backend
- `apps/backend/src/modules/diary/`

## Frontend
- `apps/web/src/app/(dashboard)/homework/diary/`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — diary.module.js diary.routes.js 
- **Own/feature tables:** `client_diary_entries`, `client_subjects`
