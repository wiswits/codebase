...
**Purpose.** In-class presentation tool. Deliberately de-menued once; decide wire-or-park at launch polish.

**Primary roles.** teacher

**Core workflow.** Teacher opens canvas in class → presents slides/simulations.

## Scope (current edition)
- Slide-deck / canvas classroom sessions
- Simulations
...
## Status vs spec
Current status: **BUILT, NO NAV — wire or park decision pending** — see `../STATUS.md`. Gaps between this PRD and the live
