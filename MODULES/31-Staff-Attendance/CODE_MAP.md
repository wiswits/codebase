...
## Frontend
- `apps/web/src/app/(dashboard)/hr/ (?tab=attendance)`
...
- **This module's surface:** `hr.attendance` → `/api/hr/attendance` (geofenced check-in/out, policy, holidays)
