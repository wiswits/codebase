# PRD — Student Observations

**Purpose.** Anecdotal/behaviour logging distinct from the homework diary. Waits for Khushboo's final/ assembly upstream.

**Primary roles.** teacher, principal

**Core workflow.** Teacher logs observation → coordinator/principal review → optional parent share.

## Scope (current edition)
- Behaviour/anecdotal records
- Teacher entry, admin review
