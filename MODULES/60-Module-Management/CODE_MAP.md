...
## Backend
- `apps/backend/src/modules/features/ (moduleRegistry.js = 37 canonical keys)`

## Frontend
- `Settings > Features (soon, NO page yet — Table C)`
- `superadmin/tenants/[id] Control Room`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — features.module.js features.routes.js 
- **Own/feature tables:** `client_feature_flags`, `client_qb_questions`, `client_school_feature_flags`, `client_schools`, `client_subscription_plans`, `client_subscriptions`, `client_transport_routes`
- **Spine tables read (Core — cannot be cut):** `client_organizations`, `client_roles`
