...
**Purpose.** Non-academic groupings for houses, clubs, and teams — used for events, comms targeting, and school culture features.

**Primary roles.** admin, principal

**Core workflow.** Create group → add members → target in events/communication.
