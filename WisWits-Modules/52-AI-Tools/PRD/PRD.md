...
**Purpose.** Teacher-workload killers. AI only suggests — human confirms; every output editable; every action logged (§12 AI rules).

**Primary roles.** teacher, principal, admin

**Core workflow.** Teacher invokes tool → AI drafts → human edits/confirms.
...
- Question generator
- Weekly insights
- AI report-card comments (nav wiring pending for admin)
