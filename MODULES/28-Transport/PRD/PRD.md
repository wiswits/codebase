...
**Purpose.** Bus routes and who rides them, with a dedicated driver surface.

**Primary roles.** admin, principal, parent (view), driver

**Core workflow.** Define routes/vehicles → assign students → driver sees manifest.

## Scope (current edition)
- Routes, vehicles, drivers
- Student assignment
- Driver portal landing
