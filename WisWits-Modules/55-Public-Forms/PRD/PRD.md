...
**Purpose.** Public-facing forms (enquiries, registrations for events) built by the school.

**Primary roles.** admin; public submits

**Core workflow.** Build form → share link → submissions flow in.

## Scope (current edition)
- No-code public form builder
- Submission inbox
