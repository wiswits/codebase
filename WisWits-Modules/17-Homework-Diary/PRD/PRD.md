...
**Purpose.** The classic school diary, digital. NOT behaviour notes (that's Student Observations, a separate gap).

**Primary roles.** teacher; student/parent read

**Core workflow.** Teacher posts per section/subject → students/parents see today's homework.

## Scope (current edition)
- Daily homework entries per section
