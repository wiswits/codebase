...
// ============================================
const removeFromErrorBook = async (req, res, next) => {
    try {
        const { id } = req.params;
        ...
        logger.info(`Question removed from error book: ${id}`);
...
// MARK AS MASTERED
// ============================================
const markAsMastered = async (req, res, next) => {
    try {
        const { id } = req.params;
        ...
        logger.info(`Question marked as mastered: ${id}`);
...
// ============================================
const getErrorBookStats = async (req, res, next) => {
    try {
        const { studentId } = req.params;
