// ========================================
// THEME TOGGLE - Complete Management
// ========================================
...
(function() {
    ...
    function applyTheme(theme) {
        ...
        if (meta) {
            meta.content = theme === 'light' ? '#F8F9FC' : '#0A0A0F';
        }
    ...
    function initThemeToggle() {
        ...
        // Also find any other theme toggle buttons
...
console.log(`🌓 Current theme: ${localStorage.getItem('edutech-theme') || 'dark'}`);