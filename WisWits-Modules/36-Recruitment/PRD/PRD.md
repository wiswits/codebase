...
**Purpose.** Hiring pipeline for schools (teacher hiring season). Conveyor P1.

**Primary roles.** hr_manager, principal, admin

**Core workflow.** Post vacancy → applicants → interviews scheduled → offer issued → joins as staff.

## Scope (current edition)
- Vacancies → applicants → interviews → offers
- Pipeline board
...
## Status vs spec
Current status: **GAP — EduSuite build ready** — see `../STATUS.md`. Gaps between this PRD and the live
