# PRD — Reports and Exports

**Purpose.** Everything a school prints or takes to a board meeting.

**Primary roles.** admin, principal, accountant

**Core workflow.** Pick report → parameters → CSV/PDF.

## Scope (current edition)
- CSV/export reports (financial, academic, top performers)
- Year-in-numbers (valuereport)
