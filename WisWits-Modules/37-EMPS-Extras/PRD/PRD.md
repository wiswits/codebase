...
**Purpose.** Employee productivity extras. Port ONLY the delta (tasks/meetings/chat) after overlap check — not the whole EMPS app.

**Primary roles.** staff, hr_manager
...
## Status vs spec
Current status: **PARTIAL GAP — only tasks/meetings/chat missing** — see `../STATUS.md`. Gaps between this PRD and the live
