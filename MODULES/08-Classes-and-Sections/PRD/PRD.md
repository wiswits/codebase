# PRD — Classes and Sections

**Purpose.** The academic skeleton every enrolment, timetable slot, and assessment hangs on. Teaching-vs-running distinction (incharge vs subject teacher) is load-bearing.

**Primary roles.** admin, principal, academic coordinator

**Core workflow.** Session created → classes → sections → subjects → teacher assignments.

## Scope (current edition)
- Class + section hierarchy
- Subject mapping
- Class incharge / section class-teacher roles
