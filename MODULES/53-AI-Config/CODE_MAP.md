...
## Backend
- `apps/backend/src/modules/ai-config/`
...
- **Own code (frozen prod snapshot):** `code/apps/…` — ai-config.module.js ai-config.routes.js 
- **Own/feature tables:** `client_ai_usage_log`, `client_org_ai_config`
